...
* `CONFIG_FOLDER`: maps to aria2 config folder into container , it has to be an subfolder, in other words,the folder should not exist,but all the path to it has to exist,otherwise the container will not work
